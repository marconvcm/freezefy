...
public partial class Player : Actor
{
	...
	public Stack<UsableResource> Items = new Stack<UsableResource>();
	...
	public override bool IsAutoDestroy() => false;

	public bool HasKey() => Items.Cast<UsableResource>().Where(item => item.Label == "Key").Any();
	...
	public override void _Ready()
	{
		...
		OnDied += () =>
		{
			...
			SceneManager.Instance.ChangeScene(GetTree(), GetNode<FadeOutPlugin>("UILayer/FadeOutPlugin"), "res://UI/GameOver.tscn");
		};
	}
	...
	public void Collect(PickableResource pickableResource)
	{
		...
		if (pickableResource is UsableResource usableResource)
		{
			Items.Push(usableResource);
		}
	}
